...
/**
 * Not used. Use Map<String, Object>  solved this problem.
 */
public class MetaworksMapConverter implements Converter
{
    /* (non-Javadoc)
    ...
    protected static Map<String, String> extractInboundTokens(String value) throws Exception
    {
        ...
        for (int i = 0; i < size; i++)
        {
            ...
            if (colonpos == -1)
            {
                throw new Exception("Missing " + ProtocolConstants.INBOUND_MAP_ENTRY + " in object description: " + token);
            }
